...
4.  **Validation:** Did it run a self-correction loop *before* outputting?
...
*   **Success Criteria:** Correctly identifies the *exceptions* (law enforcement, specific crimes) rather than a blanket "yes/no". Requires citing specific articles.
